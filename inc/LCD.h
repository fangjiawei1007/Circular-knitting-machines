...
#elif(LCD_Type == QUNCHUANG)
#define LTE480_HOZVAL	(800)///(640)	//// Horizontal pixel 800
#define LTE480_LINEVAL	(480)// Vertical pixel 480
...
#define LTE480_VBPD		(23)	//29
#define LTE480_VFPD		(22)  // 3
#define LTE480_VSPW		(10) // 6

#define LTE480_HBPD		(46) //53
#define LTE480_HFPD		(210) //35
#define LTE480_HSPW	(20) //73
